...
class LongTermMemory:
    ...
    """
    def __init__(self, client, embedding_fn, name="udaplay_longterm"):
    ...
    def register(self, memory_fragment:MemoryFragment, namespace="web_search", metadata:Optional[Dict[str, str]]=None):
        """
        ...
        self.collection.add(
            ids=[f"{memory_fragment.owner}_{memory_fragment.timestamp}"],
            documents=[memory_fragment.content],
            metadatas=[complete_metadata]
        )

    def search(self, query_text:str, owner="default", limit:int=3,
               timestamp_filter:Optional[TimestampFilter]=None, 
               namespace:Optional[str]="web_search") -> MemorySearchResult:
        """
        ...
        Args:
            ...
            namespace (Optional[str]): Namespace to search within (default: "web_search")
