...
class VectorStoreManager:
    ...
    def __init__(self, openai_api_key: Optional[str] = None, base_url: Optional[str] = None):
        ...
        self.embedding_function = self._create_embedding_function(api_key=openai_api_key, base_url=base_url)

    def _create_embedding_function(self, api_key: Optional[str] = None, base_url: Optional[str] = None) -> EmbeddingFunction:
